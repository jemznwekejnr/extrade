                ...
                <div class="col-md-7 col-lg-6 col-xl-5">
                    <div class="card p-4 mb-0 mt-7 mt-md-2">
                        <div class="card-body">
                            ...
                            <div class="btn-list d-lg-flex">
                                <a href="https://www.google.com/gmail/" target="_blank" class="btn btn-danger btn-w-lg d-block">Google</a>
                                <a href="https://twitter.com/" target="_blank" class="btn btn-info d-lg-inline d-block">Twitter</a>
                                <a href="https://www.facebook.com/" target="_blank" class="btn btn-primary d-lg-inline d-block me-2">Facebook</a>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a role="button" href="index.html" class="btn btn-lg btn-primary btn-block px-4"><i class="fe fe-arrow-right"></i> Create a new account</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="text-center pt-4">
                        <div class="font-weight-normal fs-16">You Already have an account <a class="btn-link font-weight-normal" href="login-1.html">Login Here</a></div>
                    </div>
                </div>
            </div>
        </div>
