                ...
                <div class="col-md-7 col-lg-6 col-xl-5">
                    <div class="card p-4 mb-0 mt-7 mt-md-2">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="index.html" role="button" class="btn btn-lg btn-primary btn-block"><i class="fe fe-arrow-right"></i> Login</a>
                                </div>
                                <div class="col-12">
                    ...
                    <div class="text-center pt-4">
                        <div class="font-weight-normal fs-16">You Don't have an account <a class="btn-link font-weight-normal" href="register-1.html">Register Here</a></div>
                    </div>
                </div>
            </div>
        </div>
