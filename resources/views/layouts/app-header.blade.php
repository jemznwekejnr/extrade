    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="header-brand" href="index.html">
                <img src="{{ asset('assets/images/brand/extrade-logo.png') }}" style="width: 150px; height: 70px;" class="header-brand-img desktop-lgo" alt="Dashtic logo">
                <img src="{{ asset('assets/images/brand/extrade-logo.png') }}" style="width: 150px; height: 70px;" class="header-brand-img dark-logo" alt="Dashtic logo">
                <img src="{{ asset('assets/images/brand/extrade-logo.png') }}" style="width: 150px; height: 70px;" class="header-brand-img mobile-logo" alt="Dashtic logo">
                <img src="{{ asset('assets/images/brand/extrade-logo.png') }}" style="width: 150px; height: 70px;" class="header-brand-img darkmobile-logo" alt="Dashtic logo">
            </a>
