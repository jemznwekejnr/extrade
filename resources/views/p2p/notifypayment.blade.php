                           ...
                           <!-- <div class="tab-menu-heading crypto-tabs">
                            ...
                            <div class="card panel-body tabs-menu-body br-tl-0 border-top-0 p-6 w-100 shadow2 crypto-content">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab5">
                                        <div class="mb-0 border">
                                            <div class="card-body">
                                                <div class="card-title text-start text-dark">Notify Payment</div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <div class="font-weight-bold d-flex">
                                                            ...
                                                            <div class="mt-1 d-sm-block" style="text-align: left; padding-top: 10px;">
                                                                <h5 class="font-weight-semibold mb-0">Leave this window open, copy the seller's account details below, make transfer of the exact amount to the seller.</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="mb-3">
                                            ...
                                            <div class=" d-flex">
                                                ...
                                                <small><b>ATTENTION ! </b>use this <i>Order No</i> as payment description, do not include anything crypto or BTC in your description.</small></div>

                                                <div class="mb-3">
                                                    <div class="font-weight-bold d-flex">
                                                            <div class="avatat avatar-md brround me-2" style="border-radius: 500px; background-color: #FFAC1C; text-align: center;">2</div>
                                                            <div class="mt-1 d-sm-block" style="text-align: left; padding-top: 10px;">
                                                                <h5 class="font-weight-semibold mb-0">After transferring the funds, click on <i>Payment Completed</i> button below..</h5>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="mb-3 text-center" style="margin-top: 20px;">
                                    <button type="submit" class="btn btn-danger">Cancel Order</button> <button type="submit" class="btn btn-success">Payment Completed</button>
                                </div>
                            </div>
                            </div>
                        </div>
